...
- CSP headers required — coordinate with Frozone on firebase.json.
- Firestore rules are security-critical.

### From Violet (Admin Dev)
...
- Dark mode gaps in home.html and offline.html (Dash's scope).
...
- HabitBuilder: gamified habit-tracking web app, Duolingo-inspired UI
