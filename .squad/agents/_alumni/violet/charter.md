...
## Scope
- admin.html — admin dashboard (Dashboard, Tasks, Payments, Levels, Admins, FAQ, Settings tabs)
...
## Boundaries
- Does NOT modify user-facing pages (Dash's domain)
- Does NOT modify Firebase functions or Firestore rules (Frozone's domain)
...
- Admin tabs: Dashboard, Tasks, Payments, Levels, Admins, FAQ, Settings
