...
exports.sendAdminInvite = onRequest(
  ...
  async (request, response) => {
    ...
    try {
        ...
        <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          <div style="text-align: center; margin-bottom: 30px;">
            <h1 style="color: #4f46e5; margin: 0;">
              <a href="${baseUrl}" style="color: #4f46e5; text-decoration: none;">HabitBuilder</a>
            </h1>
          ...
          <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 12px; padding: 30px; color: white; margin-bottom: 20px;">
            ...
            <p style="margin: 0; font-size: 16px; line-height: 1.6;">
              <strong>${senderName}</strong> has invited you to become an admin for <strong>${profileName}</strong>'s HabitBuilder profile.
            </p>
          </div>
          ...
          <p style="color: #6b7280; font-size: 14px; text-align: center;">
            New to HabitBuilder? <a href="${guideUrl}" style="color: #4f46e5;">Read our Admin Guide</a> to get started.
          </p>
          ...
          <p style="color: #9ca3af; font-size: 12px; text-align: center; margin: 0;">
            ...
            <a href="${baseUrl}" style="color: #4f46e5;">HabitBuilder</a>.
      ...
      const emailText = `
You're Invited to HabitBuilder!

${senderName} has invited you to become an admin for ${profileName}'s HabitBuilder profile.
...
New to HabitBuilder? Read our Admin Guide: ${guideUrl}

---
This invitation was sent by ${senderName} via HabitBuilder (${baseUrl}).
If you weren't expecting this, you can safely ignore this email.
      ...
      const msg = {
        ...
        subject: `${senderName} invited you to manage ${profileName}'s HabitBuilder`,
        text: emailText,
        html: emailHtml,
      };
