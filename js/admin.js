        ...
        const DEFAULT_DAILY_BONUSES = [
            ...
            { id: 122, name: "🚗 Clean out the car", value: 50 },
            { id: 109, name: "🗑️ Throw away one thing you don't need", value: 50 },
            { id: 123, name: "🔗 Try NYTimes Connections", value: 35 },
            { id: 103, name: "🌳 Spend 10 minutes outside", value: 50 },
            { id: 106, name: "🔋 Charge devices overnight", value: 50 },
            { id: 111, name: "🧽 Wipe down a counter or surface", value: 50 },
            { id: 112, name: "🛏️ Make the bed", value: 50 },
            { id: 114, name: "🧘 Do 5 minutes of stretching", value: 50 },
            { id: 115, name: "💊 Take vitamins", value: 50 },
            { id: 120, name: "📧 Clear out old emails", value: 50 },
            { id: 121, name: "📝 Make a to-do list for tomorrow", value: 50 },
            { id: 104, name: "🎵 Listen to a new song", value: 50 },
            { id: 105, name: "📞 Call or text a friend", value: 100 },
            { id: 116, name: "📖 Read for 10 minutes", value: 50 },
            { id: 117, name: "🎧 Listen to a podcast", value: 50 },
            { id: 118, name: "📺 Watch something new on streaming", value: 50 },
            { id: 119, name: "📱\u00a0Delete an unused app", value: 50 },
            { id: 130, name: "🧮\u00a0Play Sudoku", value: 50 },
            { id: 131, name: "🎓\u00a0Learn one new fact", value: 50 },
            { id: 132, name: "✍️\u00a0Write down a memory", value: 50 },
            { id: 133, name: "🗺️\u00a0Take a different route", value: 50 },
            { id: 134, name: "👋\u00a0Say hi to a neighbor", value: 50 },
            { id: 135, name: "😂\u00a0Share a joke or funny video", value: 50 },
            { id: 136, name: "🖼️\u00a0Share a photo with family", value: 50 },
            { id: 147, name: "💬\u00a0Have a 15+ minute conversation", value: 50 },
            { id: 138, name: "🦵\u00a0Do 5 sit-to-stands", value: 50 },
            { id: 139, name: "🚶‍♂️\u00a0Walk 10 minutes after a meal", value: 50 },
            { id: 140, name: "🙏\u00a0Write 3 things you're grateful for", value: 50 },
            { id: 141, name: "🌅\u00a0Sit quietly for 5 minutes", value: 50 },
            ...
            { id: 150, name: "📚\u00a0Read for 10+ minutes (book)", value: 50 }
        ];
        ...
        const DEFAULT_WEEKLY_BONUSES = [
            { id: 301, name: "💿 Sell coins or vinyls", value: 500 },
            { id: 331, name: "🔍 Research 5 coins or vinyls", value: 300 },
            { id: 302, name: "📺 Watch show/movie (streaming)", value: 200 },
            { id: 305, name: "🍿 Use the microwave", value: 50 },
            { id: 306, name: "🛒 Check Aisle app for deals", value: 150 },
            { id: 307, name: "💑 Take wife to lunch/dinner", value: 500 },
            { id: 308, name: "🍽️ Try a new restaurant", value: 300 },
            { id: 309, name: "💌 Tell a kid you're thinking of them", value: 200 },
            { id: 310, name: "❤️ Do something nice for wife", value: 300 },
            { id: 311, name: "🛍️ Buy a new grocery item", value: 150 },
            { id: 312, name: "🍔 Lunch with tennis friends", value: 300 },
            { id: 313, name: "🤖 Use ChatGPT to solve something", value: 200 },
            { id: 315, name: "📦 Get rid of 3 office items", value: 300 },
            { id: 316, name: "👕 Donate clothing", value: 250 },
            { id: 317, name: "👟 Donate sneakers", value: 250 },
            { id: 318, name: "🕵️ Apply for a Mystery Shop", value: 200 },
            { id: 319, name: "🗑️ Throw away 5 items", value: 200 },
            { id: 320, name: "📚 Start or continue a book", value: 200 },
            { id: 321, name: "🎬 Watch a documentary", value: 200 },
            { id: 322, name: "☕ Have coffee/lunch with someone new", value: 300 },
            { id: 324, name: "🏊 Try a gentle new activity", value: 300 },
            { id: 325, name: "🩺 Schedule or attend a health appointment", value: 250 },
            { id: 326, name: "📝 Write a letter or card to someone", value: 300 },
            { id: 330, name: "📦 Organize one area of the house", value: 200 }
        ];
